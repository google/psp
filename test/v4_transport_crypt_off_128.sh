...
ENCRYPT_PCAP="../pcap/v4_encrypt_transport_crypt_off_128.pcap"
DECRYPT_PCAP="../pcap/v4_decrypt_transport_crypt_off_128.pcap"
DECRYPT_PCAP_TXT="../pcap/v4_decrypt_transport_crypt_off_128_pcap.txt"
DIFF="./v4_transport_crypt_off_128.diff"
