...
ENCRYPT_PCAP="../pcap/v6_encrypt_transport_no_crypt_off_256.pcap"
DECRYPT_PCAP="../pcap/v6_decrypt_transport_no_crypt_off_256.pcap"
DECRYPT_PCAP_TXT="../pcap/v6_decrypt_transport_no_crypt_off_256_pcap.txt"
DIFF="./v6_transport_no_crypt_off_256.diff"
