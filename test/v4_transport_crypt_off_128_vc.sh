...
ENCRYPT_CFG="../cfg/encrypt_transport_crypt_off_128_vc.cfg"
DECRYPT_CFG="../cfg/decrypt.cfg"
CLEARTEXT_PCAP="../pcap/v4_cleartext.pcap"
CLEARTEXT_PCAP_TXT="../pcap/v4_cleartext_pcap.txt"
ENCRYPT_PCAP="../pcap/v4_encrypt_transport_crypt_off_128_vc.pcap"
DECRYPT_PCAP="../pcap/v4_decrypt_transport_crypt_off_128_vc.pcap"
DECRYPT_PCAP_TXT="../pcap/v4_decrypt_transport_crypt_off_128_vc_pcap.txt"
DIFF="./v4_transport_crypt_off_128_vc.diff"
