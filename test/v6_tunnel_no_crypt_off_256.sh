...
ENCRYPT_PCAP="../pcap/v6_encrypt_tunnel_no_crypt_off_256.pcap"
DECRYPT_PCAP="../pcap/v6_decrypt_tunnel_no_crypt_off_256.pcap"
DECRYPT_PCAP_TXT="../pcap/v6_decrypt_tunnel_no_crypt_off_256_pcap.txt"
DIFF="./v6_tunnel_no_crypt_off_256.diff"
