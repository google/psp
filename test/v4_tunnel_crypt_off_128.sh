...
ENCRYPT_CFG="../cfg/encrypt_tunnel_crypt_off_128.cfg"
DECRYPT_CFG="../cfg/decrypt.cfg"
CLEARTEXT_PCAP="../pcap/v4_cleartext.pcap"
CLEARTEXT_PCAP_TXT="../pcap/v4_cleartext_pcap.txt"
ENCRYPT_PCAP="../pcap/v4_encrypt_tunnel_crypt_off_128.pcap"
DECRYPT_PCAP="../pcap/v4_decrypt_tunnel_crypt_off_128.pcap"
DECRYPT_PCAP_TXT="../pcap/v4_decrypt_tunnel_crypt_off_128_pcap.txt"
DIFF="./v4_tunnel_crypt_off_128.diff"
