...
ENCRYPT_CFG="../cfg/encrypt_tunnel_no_crypt_off_256_vc.cfg"
DECRYPT_CFG="../cfg/decrypt.cfg"
CLEARTEXT_PCAP="../pcap/v6_cleartext.pcap"
CLEARTEXT_PCAP_TXT="../pcap/v6_cleartext_pcap.txt"
ENCRYPT_PCAP="../pcap/v6_encrypt_tunnel_no_crypt_off_256_vc.pcap"
DECRYPT_PCAP="../pcap/v6_decrypt_tunnel_no_crypt_off_256_vc.pcap"
DECRYPT_PCAP_TXT="../pcap/v6_decrypt_tunnel_no_crypt_off_256_vc_pcap.txt"
DIFF="./v6_tunnel_no_crypt_off_256_vc.diff"
