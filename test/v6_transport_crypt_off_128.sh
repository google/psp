...
ENCRYPT_CFG="../cfg/encrypt_transport_crypt_off_128.cfg"
DECRYPT_CFG="../cfg/decrypt.cfg"
CLEARTEXT_PCAP="../pcap/v6_cleartext.pcap"
CLEARTEXT_PCAP_TXT="../pcap/v6_cleartext_pcap.txt"
ENCRYPT_PCAP="../pcap/v6_encrypt_transport_crypt_off_128.pcap"
DECRYPT_PCAP="../pcap/v6_decrypt_transport_crypt_off_128.pcap"
DECRYPT_PCAP_TXT="../pcap/v6_decrypt_transport_crypt_off_128_pcap.txt"
DIFF="./v6_transport_crypt_off_128.diff"
