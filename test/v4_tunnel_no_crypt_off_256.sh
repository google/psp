...
ENCRYPT_CFG="../cfg/encrypt_tunnel_no_crypt_off_256.cfg"
DECRYPT_CFG="../cfg/decrypt.cfg"
CLEARTEXT_PCAP="../pcap/v4_cleartext.pcap"
CLEARTEXT_PCAP_TXT="../pcap/v4_cleartext_pcap.txt"
ENCRYPT_PCAP="../pcap/v4_encrypt_tunnel_no_crypt_off_256.pcap"
DECRYPT_PCAP="../pcap/v4_decrypt_tunnel_no_crypt_off_256.pcap"
DECRYPT_PCAP_TXT="../pcap/v4_decrypt_tunnel_no_crypt_off_256_pcap.txt"
DIFF="./v4_tunnel_no_crypt_off_256.diff"
