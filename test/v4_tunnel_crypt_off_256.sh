...
ENCRYPT_PCAP="../pcap/v4_encrypt_tunnel_crypt_off_256.pcap"
DECRYPT_PCAP="../pcap/v4_decrypt_tunnel_crypt_off_256.pcap"
DECRYPT_PCAP_TXT="../pcap/v4_decrypt_tunnel_crypt_off_256_pcap.txt"
DIFF="./v4_tunnel_crypt_off_256.diff"
